                ...
                #endif /* (I2C_SECONDARY_ADDRESS_ENABLE_CONST) */
                    {
                        ...
                        case I2C_EZI2C_FSM_BYTE_WRITE:
                            if(0u != locBufSize)
                            {
                                ...
                                I2C_dataBuffer[locIndex] = (uint8) locByte;
                                locIndex++;
                                locBufSize--;
                            }
                            else
                        ...
                        case I2C_EZI2C_FSM_OFFSET_LO8:
                            ...
                            if(locByte < (uint32) I2C_bufSizeBuf)
                            {
                                I2C_I2C_SLAVE_GENERATE_ACK;
                                ...
                                locBufSize = (uint16) ((locByte < I2C_protectBuf) ?
                                                       (I2C_protectBuf - locByte) : (0u));
                ...
                else if (0u != (I2C_I2C_CTRL_REG & I2C_I2C_CTRL_S_READY_DATA_ACK))
                {
                    ...
                    */
                    ...
                    for(; (0u != fifoIndex); fifoIndex--)
                    {
                        ...
                        I2C_dataBuffer[locIndex] = (uint8) I2C_RX_FIFO_RD_REG;
                        locIndex++;
                    }
                ...
                if(0u != (locIntrSlave & I2C_INTR_SLAVE_I2C_ADDR_MATCH))
                {
                ...
                #endif /* (I2C_SECONDARY_ADDRESS_ENABLE_CONST) */
                    {
                        ...
                        if(I2C_CHECK_I2C_STATUS(I2C_I2C_STATUS_S_READ))
                        {
                            ...
                            locBufSize = I2C_bufSizeBuf - (uint16) locIndex;
            ...
            */
            if(0u != (I2C_GetInterruptCause() & I2C_INTR_CAUSE_TX))
            {
                ...
                do
                {
                    ...
                    if(0u != locBufSize)
                    {
                        I2C_TX_FIFO_WR_REG = (uint32) I2C_dataBuffer[locIndex];
                        locIndex++;
                        locBufSize--;
                    }
                    else
