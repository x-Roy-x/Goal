// ======================================================================
// SmartBoy.v generated from TopDesign.cysch
// 05/05/2021 at 00:45
...
// CharLCD_v2_20(ConversionRoutines=true, CUSTOM0="0,0,0,0,0,11,A,4,", CUSTOM1="E,1B,11,13,17,1F,1F,0,", CUSTOM2="0,0,0,0,0,0,0,0,", CUSTOM3="0,0,0,0,0,0,0,0,", CUSTOM4="0,0,0,0,0,0,0,0,", CUSTOM5="6,9,9,6,0,0,0,0,", CUSTOM6="0,15,E,1B,E,15,0,0,", CUSTOM7="0,E,11,E,1,10,2,8,", CustomCharacterSet=3, TypeReplacementString=uint32, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=CharLCD_v2_20, CY_CONFIG_TITLE=LCD, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=LCD, CY_INSTANCE_SHORT_NAME=LCD, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=20, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=LCD, )
module CharLCD_v2_20_0 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("068b6196-7794-4f09-87c2-a638e9b010c0/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module ADC_SAR_SEQ_P4_v2_60_1 (
	...
	cy_clock_v1_0
		#(.id("57908b66-a70d-47b6-8ef5-9e92d2eecd8f/5c71752a-e182-47ca-942c-9cb20adbdf2f"),
		  .source_clock_id(""),
		  .divisor(0),
...
// TCPWM_P4_v2_10(Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, PinVisibility_index=false, PinVisibility_kill=false, PinVisibility_phiA=false, PinVisibility_phiB=false, PinVisibility_switch=false, PWMCompare=65535, PWMCompareBuf=65535, PWMCompareSwap=0, PWMCountMode=3, PWMCountPresent=false, PWMDeadTimeCycle=0, PWMInterruptMask=1, PWMKillEvent=0, PWMLinenSignal=0, PWMLineSignal=0, PWMMode=4, PWMPeriod=65535, PWMPeriodBuf=65535, PWMPeriodSwap=0, PWMPrescaler=0, PWMReloadMode=0, PWMReloadPresent=false, PWMRunMode=0, PWMSetAlign=0, PWMStartMode=0, PWMStartPresent=false, PWMStopEvent=0, PWMStopMode=0, PWMStopPresent=false, PWMSwitchMode=0, PWMSwitchPresent=false, QuadAutoStart=true, QuadEncodingModes=0, QuadIndexMode=0, QuadIndexPresent=false, QuadInterruptMask=1, QuadPhiAMode=3, QuadPhiBMode=3, QuadStopMode=0, QuadStopPresent=false, TCCaptureMode=0, TCCapturePresent=false, TCCompare=65535, TCCompareBuf=65535, TCCompareSwap=0, TCCompCapMode=2, TCCountingModes=0, TCCountMode=3, TCCountPresent=false, TCInterruptMask=0, TCPeriod=1000, TCPrescaler=0, TCPWMCapturePresent=false, TCPWMConfig=1, TCPWMCountPresent=false, TCPWMReloadPresent=false, TCPWMStartPresent=false, TCPWMStopPresent=false, TCReloadMode=0, TCReloadPresent=false, TCRunMode=0, TCStartMode=0, TCStartPresent=false, TCStopMode=0, TCStopPresent=false, TermMode_capture=0, TermMode_cc=0, TermMode_clock=0, TermMode_count=0, TermMode_interrupt=0, TermMode_line=0, TermMode_line_n=0, TermMode_ov=0, TermMode_reload=0, TermMode_start=0, TermMode_stop=0, TermMode_un=0, TermModeStates=, TermVisibility_capture=false, TermVisibility_cc=true, TermVisibility_clock=true, TermVisibility_count=false, TermVisibility_interrupt=true, TermVisibility_line=false, TermVisibility_line_n=false, TermVisibility_ov=true, TermVisibility_reload=false, TermVisibility_start=false, TermVisibility_stop=false, TermVisibility_un=true, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=TCPWM_P4_v2_10, CY_CONFIG_TITLE=Timer_Update, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Timer_Update, CY_INSTANCE_SHORT_NAME=Timer_Update, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=Timer_Update, )
...
module top ;
	...
	wire [0:0] tmpOE__ADC_SENSOR_1_net;
	wire [0:0] tmpFB_0__ADC_SENSOR_1_net;
	wire [0:0] tmpIO_0__ADC_SENSOR_1_net;
	wire [0:0] tmpINTERRUPT_0__ADC_SENSOR_1_net;
	electrical [0:0] tmpSIOVREF__ADC_SENSOR_1_net;
	...
	cy_psoc3_pins_v1_10
		...
		ADC_SENSOR_1
		 (.oe(tmpOE__ADC_SENSOR_1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__ADC_SENSOR_1_net[0:0]}),
		  .analog({Net_711}),
		  .io({tmpIO_0__ADC_SENSOR_1_net[0:0]}),
		  .siovref(tmpSIOVREF__ADC_SENSOR_1_net),
		  .interrupt({tmpINTERRUPT_0__ADC_SENSOR_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ADC_SENSOR_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_clock_v1_0
		#(.id("d1e89f22-8e3c-44d1-a203-d9ff17cc6d01"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	wire [0:0] tmpOE__Button_Scan_net;
	wire [0:0] tmpIO_0__Button_Scan_net;
	wire [0:0] tmpINTERRUPT_0__Button_Scan_net;
	electrical [0:0] tmpSIOVREF__Button_Scan_net;

	cy_psoc3_pins_v1_10
		#(.id("e2033129-eb35-4e0a-bb5b-a214e8f7fd64"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Button_Scan
		 (.oe(tmpOE__Button_Scan_net),
		  .y({1'b0}),
		  .fb({Net_193}),
		  .io({tmpIO_0__Button_Scan_net[0:0]}),
		  .siovref(tmpSIOVREF__Button_Scan_net),
		  .interrupt({tmpINTERRUPT_0__Button_Scan_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Button_Scan_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    Debouncer_v1_0 Debouncer_Button_Scan (
        .d(Net_193),
        .clock(Net_99),
        .q(Net_195),
        .neg(Net_265),
        .either(Net_197),
        .pos(Net_198));
    defparam Debouncer_Button_Scan.EitherEdgeDetect = 1;
    defparam Debouncer_Button_Scan.NegEdgeDetect = 1;
    defparam Debouncer_Button_Scan.PosEdgeDetect = 1;
    defparam Debouncer_Button_Scan.SignalWidth = 1;

	wire [0:0] tmpOE__Button_Reset_net;
	wire [0:0] tmpIO_0__Button_Reset_net;
	wire [0:0] tmpINTERRUPT_0__Button_Reset_net;
	electrical [0:0] tmpSIOVREF__Button_Reset_net;

	cy_psoc3_pins_v1_10
		#(.id("f5c8c5b8-c05d-40ab-91a8-a51414d3d940"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Button_Reset
		 (.oe(tmpOE__Button_Reset_net),
		  .y({1'b0}),
		  .fb({Net_188}),
		  .io({tmpIO_0__Button_Reset_net[0:0]}),
		  .siovref(tmpSIOVREF__Button_Reset_net),
		  .interrupt({tmpINTERRUPT_0__Button_Reset_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Button_Reset_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    Debouncer_v1_0 Debouncer_Button_Reset (
        .d(Net_188),
        .clock(Net_99),
        .q(Net_190),
        .neg(Net_117),
        .either(Net_191),
        .pos(Net_192));
    defparam Debouncer_Button_Reset.EitherEdgeDetect = 1;
    defparam Debouncer_Button_Reset.NegEdgeDetect = 1;
    defparam Debouncer_Button_Reset.PosEdgeDetect = 1;
    defparam Debouncer_Button_Reset.SignalWidth = 1;


	cy_clock_v1_0
		#(.id("5bf11e96-5846-4d7e-a50a-eabd617307b5"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	wire [0:0] tmpOE__Status_LED_Red_net;
	wire [0:0] tmpFB_0__Status_LED_Red_net;
	wire [0:0] tmpIO_0__Status_LED_Red_net;
	wire [0:0] tmpINTERRUPT_0__Status_LED_Red_net;
	electrical [0:0] tmpSIOVREF__Status_LED_Red_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		Status_LED_Red
		 (.oe(tmpOE__Status_LED_Red_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Status_LED_Red_net[0:0]}),
		  .io({tmpIO_0__Status_LED_Red_net[0:0]}),
		  .siovref(tmpSIOVREF__Status_LED_Red_net),
		  .interrupt({tmpINTERRUPT_0__Status_LED_Red_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Status_LED_Red_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    TCPWM_P4_v2_10_4 Timer_Update (
        .stop(1'b0),
        .reload(1'b0),
        .start(1'b0),
        .count(1'b1),
	...
	cy_clock_v1_0
		#(.id("23f2801d-3a07-4bf3-ad91-9871b293cff3"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000000"),
		  .is_direct(0),
	...
	wire [0:0] tmpOE__ADC_SENSOR_2_net;
	wire [0:0] tmpFB_0__ADC_SENSOR_2_net;
	wire [0:0] tmpIO_0__ADC_SENSOR_2_net;
	wire [0:0] tmpINTERRUPT_0__ADC_SENSOR_2_net;
	electrical [0:0] tmpSIOVREF__ADC_SENSOR_2_net;

	cy_psoc3_pins_v1_10
		#(.id("6186384b-41d3-4e5f-a55d-7597824a7b40"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		ADC_SENSOR_2
		 (.oe(tmpOE__ADC_SENSOR_2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__ADC_SENSOR_2_net[0:0]}),
		  .analog({Net_375}),
		  .io({tmpIO_0__ADC_SENSOR_2_net[0:0]}),
		  .siovref(tmpSIOVREF__ADC_SENSOR_2_net),
		  .interrupt({tmpINTERRUPT_0__ADC_SENSOR_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ADC_SENSOR_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Status_LED_Green_net;
	wire [0:0] tmpFB_0__Status_LED_Green_net;
	wire [0:0] tmpIO_0__Status_LED_Green_net;
	wire [0:0] tmpINTERRUPT_0__Status_LED_Green_net;
	electrical [0:0] tmpSIOVREF__Status_LED_Green_net;

	cy_psoc3_pins_v1_10
		#(.id("207bf163-179e-4266-a637-1b2966549a9e"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Status_LED_Green
		 (.oe(tmpOE__Status_LED_Green_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Status_LED_Green_net[0:0]}),
		  .io({tmpIO_0__Status_LED_Green_net[0:0]}),
		  .siovref(tmpSIOVREF__Status_LED_Green_net),
		  .interrupt({tmpINTERRUPT_0__Status_LED_Green_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Status_LED_Green_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Status_LED_Blue_net;
	wire [0:0] tmpFB_0__Status_LED_Blue_net;
	wire [0:0] tmpIO_0__Status_LED_Blue_net;
	wire [0:0] tmpINTERRUPT_0__Status_LED_Blue_net;
	electrical [0:0] tmpSIOVREF__Status_LED_Blue_net;

	cy_psoc3_pins_v1_10
		#(.id("15f06ac5-a3ea-49d8-9234-58c8da7d971b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Status_LED_Blue
		 (.oe(tmpOE__Status_LED_Blue_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Status_LED_Blue_net[0:0]}),
		  .io({tmpIO_0__Status_LED_Blue_net[0:0]}),
		  .siovref(tmpSIOVREF__Status_LED_Blue_net),
		  .interrupt({tmpINTERRUPT_0__Status_LED_Blue_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Status_LED_Blue_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
